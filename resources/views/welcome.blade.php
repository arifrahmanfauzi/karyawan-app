    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/dashboard') }}" class="px-4 text-lg text-white rounded-lg shadow-lg">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="px-4 text-lg text-white bg-blue-400 rounded-lg shadow-lg">Log
                        in</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="px-4 ml-4 text-lg text-white bg-blue-400 rounded-lg shadow-lg">Register</a>
                    @endif
                @endauth
            </div>
        @endif
        <div class="w-full mt-5 overflow-hidden text-gray-500 bg-gray-100 shadow-xl rounded-3xl"
            ...
            <div class="w-full md:flex">
                ...
                <div class="w-full px-5 py-10 md:w-1/2 md:px-10">
                    <div class="mb-10 text-center">
                        ...
                        <p>Please login or register on top </p>
                    </div>
